...
bin/cRace: bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/Lump.o bin/JoinPolicy.o bin/SelectionPolicy.o
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/Lump.o bin/JoinPolicy.o bin/SelectionPolicy.o
...
bin/Lump.o: src/Lump.cpp
	g++ -g -Wall -Weffc++ -std=c++11 -c -Iinclude -o bin/Lump.o src/Lump.cpp
